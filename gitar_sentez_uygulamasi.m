function gitar_sentez_uygulamasi()
    fig = figure('Name', 'Gitar Sentez Uygulaması', 'Position', [300, 300, 500, 300]);

    % --- Sentez tipi menüsü ---
    uicontrol('Style', 'text', 'Position', [50, 250, 100, 20], 'String', 'Sentez Tipi:');
    sentezMenu = uicontrol('Style', 'popupmenu', 'Position', [50, 230, 100, 20], ...
        'String', {'Wavetable', 'Additive'}, ...
        'Callback', @(src, event) toggleWaveformMenu());

    % --- Nota menüsü ---
    uicontrol('Style', 'text', 'Position', [200, 250, 100, 20], 'String', 'Nota:');
    notaMenu = uicontrol('Style', 'popupmenu', 'Position', [200, 230, 100, 20], ...
    ...
    % --- Çal butonu ---
    uicontrol('Style', 'pushbutton', 'Position', [200, 180, 100, 30], ...
        'String', 'Nota Çal', ...
...
function y = wavetable_sentez(f0, t, Fs, waveformIdx)
    ...
    index = floor(phase * wavetableSize) + 1;
    y = wavetable(index);
end
